...
func (p *VideoServiceGetVideosByLastTimeArgs) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *VideoServiceGetVideosByLastTimeArgs) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "user_id", thrift.I64, 2)
	offset += bthrift.Binary.WriteI64(buf[offset:], p.UserId)
...
func (p *VideoServiceGetVideosByLastTimeArgs) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("user_id", thrift.I64, 2)
	l += bthrift.Binary.I64Length(p.UserId)
...
func (p *VideoServiceGetCommentListByVideoArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VideoServiceGetCommentListByVideoArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *VideoServiceGetCommentListByVideoArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *VideoServiceGetCommentListByVideoArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *VideoServiceGetCommentListByVideoArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "GetCommentListByVideo_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *VideoServiceGetCommentListByVideoArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("GetCommentListByVideo_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *VideoServiceGetCommentListByVideoArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *VideoServiceGetCommentListByVideoArgs) field1Length() int {
	l := 0
...
func (p *VideoServiceGetCommentListByVideoResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VideoServiceGetCommentListByVideoResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *VideoServiceGetCommentListByVideoResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *VideoServiceGetCommentListByVideoResult) FastWrite(buf []byte) int {
	return 0
}

func (p *VideoServiceGetCommentListByVideoResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "GetCommentListByVideo_result")
	if p != nil {
		offset += p.fastWriteField0(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *VideoServiceGetCommentListByVideoResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("GetCommentListByVideo_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *VideoServiceGetCommentListByVideoResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "success", thrift.STRUCT, 0)
		offset += p.Success.FastWriteNocopy(buf[offset:], binaryWriter)
...
func (p *VideoServiceGetCommentListByVideoResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += bthrift.Binary.FieldBeginLength("success", thrift.STRUCT, 0)
		l += p.Success.BLength()
...
func (p *VideoServicePostCommentArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VideoServicePostCommentArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *VideoServicePostCommentArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
	p.CommentActionRequest = NewCommentActionRequest()
	if l, err := p.CommentActionRequest.FastRead(buf[offset:]); err != nil {
		return offset, err
	} else {
		offset += l
	}
...
// for compatibility
func (p *VideoServicePostCommentArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *VideoServicePostCommentArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "PostComment_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *VideoServicePostCommentArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("PostComment_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *VideoServicePostCommentArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "comment_action_request", thrift.STRUCT, 1)
	offset += p.CommentActionRequest.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}

func (p *VideoServicePostCommentArgs) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("comment_action_request", thrift.STRUCT, 1)
	l += p.CommentActionRequest.BLength()
	l += bthrift.Binary.FieldEndLength()
	return l
}

func (p *VideoServicePostCommentResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_VideoServicePostCommentResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *VideoServicePostCommentResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *VideoServicePostCommentResult) FastWrite(buf []byte) int {
	return 0
}

func (p *VideoServicePostCommentResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "PostComment_result")
	if p != nil {
		offset += p.fastWriteField0(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *VideoServicePostCommentResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("PostComment_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *VideoServicePostCommentResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "success", thrift.STRUCT, 0)
		offset += p.Success.FastWriteNocopy(buf[offset:], binaryWriter)
...
func (p *VideoServicePostCommentResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += bthrift.Binary.FieldBeginLength("success", thrift.STRUCT, 0)
		l += p.Success.BLength()
...
func (p *VideoServiceGetCommentListByVideoArgs) GetFirstArgument() interface{} {
	return p.VideoId
}

func (p *VideoServiceGetCommentListByVideoResult) GetResult() interface{} {
	return p.Success
}

func (p *VideoServicePostCommentArgs) GetFirstArgument() interface{} {
	return p.CommentActionRequest
}

func (p *VideoServicePostCommentResult) GetResult() interface{} {
	return p.Success
}
